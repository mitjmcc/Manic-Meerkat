...
//            agent.velocity = this.transform.forward * 0.1f;
	...
	void FixedUpdate() {
        ...
        //TODO figure out how to denote a controlled mode
    ...
    public void setInputValues(float currInputForward, float currInputTurn) {
        
        externalInputForward = currInputForward;
        externalInputTurn = currInputTurn;
...
//                    #endif
        ...
        //TODO TODO TODO if NPC is capable of turning in place then see if transform.forward roughly in line with 
...
//            }
                ...
                if (!agent.isOnOffMeshLink)
                {
                    ...
                    if (blocked && posDiff.magnitude > agent.radius*2f)
                    {
                        ...
                        else
                        {
                            ...
                            //TODO TODO TODO This warp is causing the destination to increment!!!!!!!!
                            //maybe need to modify internalSetDestination() to optionally preserve currWaypoint
    ...
    protected void positionCorrection(Vector3 origPos, Vector3 prevPos) {
        ...
        //TODO this should probably instead be based on whether goal reached and maybe not not StrictCorrection
